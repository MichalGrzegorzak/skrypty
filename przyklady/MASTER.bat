...
::--------------------------------------------------------
setlocal
set "backupName=bkp_FNC"

::Folder to pack
call :getFullSitePath fullSitePath 

::Pack to unique file name (datetime) in specified folder defined in config.ini
call :readConfig backupTo backupTo
call :genUniqueNAme %backupTo% %backupName% fullfileName
::echo name = %fullfileName%.zip
call :pack %fullfileName%.zip %fullSitePath%

::Update config file
call :writeConfig latestBackup %fullfileName%.zip
